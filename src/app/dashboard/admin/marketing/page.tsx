...
import { Megaphone, Search, Plus, Download, UserCheck, Clock, TrendingUp } from "lucide-react";
import { useState } from "react";

const employees = [
  { name: "Khalil Mansouri", position: "Marketing Manager", status: "Active",   phone: "+216 55 222 111", joined: "Feb 2020" },
  { name: "Lina Sfar",       position: "SEO Specialist",    status: "Active",   phone: "+216 22 777 888", joined: "Jun 2022" },
  { name: "Tarek Jebali",    position: "Content Creator",   status: "Active",   phone: "+216 98 333 666", joined: "Oct 2023" },
  { name: "Mariem Zouari",   position: "Graphic Designer",  status: "On Leave", phone: "+216 27 555 000", joined: "Apr 2021" },
  { name: "Aziz Trabelsi",   position: "Media Buyer",       status: "Active",   phone: "+216 54 111 999", joined: "Aug 2022" },
];
    ...
    <DashboardLayout>
      <div className="min-h-screen bg-gray-100 dark:bg-[#060a0f] text-gray-900 dark:text-white font-mono p-6 space-y-6 transition-colors duration-300">
        ...
        <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
          {[
            { label: t("totalMarketing"), value: "5",     sub: t("inDepartment"),    icon: <Megaphone size={14} />, iconBg: "bg-blue-500/10 text-blue-400" },
            { label: t("active"),         value: "4",     sub: t("currentlyWorking"),icon: <UserCheck size={14} />, iconBg: "bg-emerald-500/10 text-emerald-400" },
            { label: t("onLeave"),        value: "1",     sub: t("thisMonth"),       icon: <Clock size={14} />,     iconBg: "bg-amber-500/10 text-amber-400" },
            { label: t("avgTenure"),      value: "2.1yr", sub: t("avgPerEmployee"),  icon: <TrendingUp size={14} />,iconBg: "bg-purple-500/10 text-purple-400" },
          ].map((s, i) => (
        ...
        <div className={`${card} overflow-hidden`}>
          <div className="flex items-center justify-between px-6 py-5 border-b border-gray-200 dark:border-white/[0.05]">
            <div>
              <h2 className="text-base font-bold text-gray-900 dark:text-white">Marketing Team</h2>
